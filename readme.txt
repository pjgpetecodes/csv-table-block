=== CSV Table Block ===
Contributors: Peter Gallagher
Tags: gutenberg, block, csv, table
...
CSV Table Block is a Gutenberg block plugin that allows you to import and display CSV data as a table in the WordPress editor. This plugin provides an easy way to present tabular data without the need for manual formatting.
...
1. Install and activate the CSV Table Block plugin.
...
1. [Screenshot 1](screenshot-1.png) - The CSV Table Block in the Gutenberg editor.

== Frequently Asked Questions ==

= Can I customize the table styling? =

Yes, you can add custom CSS classes to the table block for styling purposes. The `is-style-stripes` class is included as a default styling option.
...
= 1.0.0 =
Initial release of the CSV Table Block plugin.
